...
<TouchableOpacity onPress={()=>router.push('/home')} className="px-3 py-2">
...
<View className="flex-row item-center gap-3 justify-center mb-3">
  <TouchableOpacity onPress={()=>setUpComing(true)} className={`h-12 px-3  items-center justify-center rounded-xl ${upcoming ?'bg-primary':'bg-light '}`}>
    <Text className={`text-lg font-medium ${upcoming ? 'text-white' :'text-primary'} `}>Upcoming</Text>
  </TouchableOpacity >
  <TouchableOpacity className={`h-12 px-3  items-center justify-center rounded-xl ${!upcoming ?'bg-primary':'bg-light '}`} onPress={()=>setUpComing(false)}>
    <Text className={`text-lg font-medium ${!upcoming ? 'text-white' :'text-primary'} `}>Completed</Text>
  </TouchableOpacity>
</View>
{upcoming ?
